...
@section('breadcrumbs')
    ...
    <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" class="active">
        <a itemprop="item" href="{{url('/themes')}}" class="">
            <span itemprop="name">
                Themes
            </span>
        </a>
                    ...
                    <tbody>
                        @foreach ($themes as $theme)
                            ...
                            <tr>
                                ...
                                --}}
                                <td class="mdl-data-table__cell--non-numeric">
                                    <a href="/scs/themes/{{$theme->id}}" class="mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect" title="{{ trans('themes.themesBtnShow') }}" id="view_theme_{{$theme->id}}">
                                    ...
                                    <a href="/scs/themes/{{$theme->id}}/edit" class="mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect" title="{{ trans('themes.themesBtnShow') }}" id="edit_theme_{{$theme->id}}">
