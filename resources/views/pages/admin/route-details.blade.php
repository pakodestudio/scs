					...
					<thead>
				  	...
				  	<tbody>
						@foreach ($routes as $route)
							<tr>
								<td class="mdl-data-table__cell--non-numeric"><a href="/scs/users">{{ $route->uri }}</a></td>
								<td class="mdl-data-table__cell--non-numeric"><a href="/scs/users">{{ $route->getName() }}</a></td>
								<td class="mdl-data-table__cell--non-numeric"><a href="/scs/users">{{ $route->getPrefix() }}</a></td>
								<td class="mdl-data-table__cell--non-numeric"><a href="/scs/users">{{ $route->getActionMethod() }}</a></td>
							</tr>
						@endforeach
				  	</tbody>
				</table>
